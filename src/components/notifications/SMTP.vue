<template>
    <div>
        ...
        <div class="mb-3">
            ...
            <input id="from-email" v-model="$parent.notification.smtpFrom" type="text" class="form-control" required autocomplete="false" placeholder="&quot;Direct Alerte&quot; &lt;example@kuma.pet&gt;">
            <div class="form-text">
            </div>
        </div>
