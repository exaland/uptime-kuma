...
requests for Direct Alerte. I never thought the GitHub community would be so nice!
...
## Can I Create a Pull Request for Direct Alerte?
...
- Make sure the **UI/UX is close to Direct Alerte**.
...
you can finally start the app. The goal is to make the Direct Alerte installation
...
Direct Alerte Frontend is a single page application (SPA). Most paths are handled
by Vue Router.
...
If you want to help by translating Direct Alerte into your language, please visit
...
- `2.x.x-beta.x`
- `nightly2`: Dev build
- `base2`: Basic Debian setup without Direct Alerte source code (Full features)
- `base2-slim`: Basic Debian setup without Direct Alerte source code
...
- `nightly`: Dev build
- `base-debian`: Basic Debian setup without Direct Alerte source code
- `pr-test`: For testing pull request without setting up a local environment
- `base-alpine`: (Deprecated) Basic Alpine setup without Direct Alerte source code
